...
Полноценный почти))) production-ready сервис для автоматической транскрибации аудиофайлов с использованием модели OpenAI Whisper. Проект реализован как набор Docker-контейнеров с REST API, фоновой обработкой задач, веб-дашбордом и встроенным мониторингом.
